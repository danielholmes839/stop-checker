          ...
          {selected && (
            ...
            >
              <div>
                ...
                <Link className="inline-block" to={`/stop/${selected.id}`}>
                  <button className="px-3 py-1 mt-2 bg-indigo-500 hover:bg-indigo-600 rounded-sm text-white text-xs tracking-wider text-white">
                    View
                  </button>
                </Link>
              </div>
